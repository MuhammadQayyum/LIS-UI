...
const AllPatients = (props) => {
  ...
  const deletePatientHandler = ((id) => {
    ...
    const renderAllPatientList = props.patients.filter((patient) => {
      if (search === "") {
        return true;
      } else {
      ...
      <tr key={patient.patId}>
        <td className = "r"><Link to={'/editPatient/'+patient.patId}> {patient.patId}</Link></td>
    ...
    return(
        ...
        <li className="nav-item">
          <input type='text' className="i" name="search" id="search" placeholder="Search by Last Name" value={search} onChange={handleSearchChange} required></input>
        </li>
        <li className="nav-item">
        <a className="nav-link"><i className="fa fa-refresh fa-spin" onClick={refresh}></i></a>
        </li>
        <li className="nav-item">
        ...
        <li className="nav-item">
            <Link to={'/getAllOrderList'}><a className="nav-link">Order List</a></Link>
        </li>
        <li>
