...
import AddOrderList from "./OrderList/AddOrderList";
import UpdateOrderList from "./OrderList/UpdateOrderList";
import "./App.css";
      ...
      <Router>
        ...
        <Routes>
          <Route
            path="/"
            exact
            Component={() => <AllPatients patients={patients} />}
          />
          <Route
            path="/addPatient"
            Component={() => (
          ...
          <Route
            path="/editPatient/:id"
            element={<EditPatient physicians={physicians} />}
          />
          <Route
            path="/allPhysicians"
            Component={() => <AllPhysicians physicians={physicians} />}
          />
          <Route path="/addPhysician" element={<AddPhysician />}></Route>
          <Route path="/editPhysician/:id" element={<EditPhysician />}></Route>
          <Route
            path="/getAllOrderList"
            element={<AllOrderList orderList={orderList} />}
          ></Route>
          <Route path="/addOrderList" element={<AddOrderList />}></Route>
          <Route path="/editOrderList/:id" element={<UpdateOrderList />}></Route>
        </Routes>
      </Router>
    </div>
  );
